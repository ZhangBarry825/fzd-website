<template>
  <div class="list-box">
    <el-row><h2>Equipment List</h2></el-row>
    <el-button-group class="buttons">
      <el-button size="small" type="primary" icon="el-icon-edit" @click="goTo('/admin-equipment/create')">
        Create
      </el-button>
...
<script>
  ...
  import {deleteEquip, getEquipList, updateEquip} from "@/api/admin-equipment";
  ...
  export default {
    ...
    methods: {
      ...
      handleClick(row) {
        this.goTo('/admin-equipment/edit?id='+row.id)
        console.log(row);
      },
